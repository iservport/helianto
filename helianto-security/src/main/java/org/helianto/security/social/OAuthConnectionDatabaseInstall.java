 ...
 */
public class OAuthConnectionDatabaseInstall 
	implements InitializingBean
{
	
	private static final Logger logger = LoggerFactory.getLogger(OAuthConnectionDatabaseInstall.class);
	 ...
	 * @param dataSource
	 */
	public OAuthConnectionDatabaseInstall(DataSource dataSource) {
		super();
