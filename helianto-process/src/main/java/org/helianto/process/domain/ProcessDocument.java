...
public class ProcessDocument extends AbstractDocument implements Comparator<ProcessDocumentAssociation> {
    ...
    private char inheritanceType = org.helianto.process.def.InheritanceType.FINAL.getValue();
	...
	public void setInheritanceType(org.helianto.process.def.InheritanceType inheritanceType) {
