...
/**
 * Default <code>ResourceAssociation</code> property editor.
 * 
...
public class ResourceAssociationPropertyEditor extends AbstractSessionPropertyEditor {
    ...
    public String getAsText() {
    	ResourceAssociation resourceAssociation = (ResourceAssociation) getValue();
        return String.valueOf(resourceAssociation.getId());
    }
    
    @Override
    public void setAsText(String id) throws IllegalArgumentException {
        setAsText(id, ResourceAssociation.class);
    }
