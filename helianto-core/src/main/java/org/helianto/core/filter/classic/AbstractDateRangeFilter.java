...
//			mainCriteriaBuilder.appendDateRange(getDateFieldName(), this);
	    	...
	    	mainCriteriaBuilder.appendAnd().openParenthesis(true);
	        if (getFromDate()!=null) {
	        	mainCriteriaBuilder.appendSegment(getDateFieldName(), ">=").append(getFromDate());
	        }
	        if (getToDate()!=null) {
	        	mainCriteriaBuilder.appendAnd(getFromDate()!=null)
