 ...
 */
public class UserSimpleFormFilterAdapter 
...

{
     ...
     * @param form
     */
    public UserSimpleFormFilterAdapter(UserGroupForm form) {
    	super(form);
    }
    ...
    private static Logger logger = LoggerFactory.getLogger(UserSimpleFormFilterAdapter.class);
