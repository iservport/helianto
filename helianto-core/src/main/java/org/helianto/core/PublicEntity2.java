...
@Table(name = "core_public"
	, uniqueConstraints = { @UniqueConstraint(columnNames = {"entityId", "entityAlias"}) })
...
//		setPublicEntityVisibility(PublicEntityVisibility.REGISTERED);
	 ...
	 * @param entity
	 */
	public PublicEntity2(Entity entity) {
		this();
		setEntity(entity);
	}
...
//	
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PublicEntity2))
			return false;
		PublicEntity2 castOther = (PublicEntity2) other;
