...
/**
 * Default <code>PropertyLoader</code> backed <code>Partner</code> property
 * editor.
 * 
 * @author Mauricio Fernandes de Castro
 */
public class PartnerPropertyEditor extends AbstractLoaderPropertyEditor {

	public PartnerPropertyEditor(PropertyLoader propertyLoader) {
