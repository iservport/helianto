...
<table>
	...
	<td style="width: 65%; vertical-align: top;">
		...
		<table>
			...
			<td><@spring.formSingleSelect "identityForm.identity.notification", notificationTypes /></td>
			</tr>
			...
			<td><@spring.formSingleSelect "identityForm.identity.identityType", identityTypes /></td>
			</tr>
